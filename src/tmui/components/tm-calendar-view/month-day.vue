<template>
  <view class="flex flex-col relative">
    ...
    <tm-button :followTheme="props.followTheme" v-if="!props.hideButton" :linear="props.linear" :linear-deep="props.linearDeep" :color="props.color" @click="confirm" block :label="_confirmText" :margin="[0, 16]"></tm-button>
  </view>
</template>
