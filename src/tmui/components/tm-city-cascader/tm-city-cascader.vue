<template>
  <view>
    <tm-cascader :value="_value" @update:modelValue="_value = $event" @change="changData" :default-value="_def" :color="props.color" :active-color="props.activeColor" :height="props.height" :slotTabHeigth="88" :data="cityAlldata"></tm-cascader>
  </view>
</template>
