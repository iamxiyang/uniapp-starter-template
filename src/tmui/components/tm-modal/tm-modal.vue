<template>
  <view>
    ...
    <!-- #endif -->
    <tm-overlay :zIndex="props.zIndex" ref="overlayAni" blur :duration="props.duration" @close="overclose" @open="OverLayOpen" @click="overlayClickFun" :align="align_rp" :overlayClick="false" v-model:show="_show" :teleport="props.teleport">
      <tm-translate :reverse="reverse_rp" :width="anwidth" :height="anheight" ref="drawerANI" :auto-play="false" :name="aniname" :duration="props.duration">
        <view
          ...
          :style="[{ width: anwidth, height: anheight, boxSizing: 'border-box' }, !props.transprent ? tmcomputed.borderCss : '', !props.transprent ? tmcomputed.backgroundColorCss : '', !props.transprent ? tmcomputed.shadowColor : '', customCSSStyle]"
            ...
            <slot name="button">
              <view v-if="!props.hideCancel" class="flex-1 overflow" style="height: 90rpx">
                <tm-sheet
                  ...
                  :padding="[0, 0]"
                >
                  <tm-text _class="text-weight-b" _style="line-height:90rpx" :dark="props.dark" :followTheme="false" :userInteractionEnabled="false" :label="props.cancelText"></tm-text>
                </tm-sheet>
              </view>
              ...
              <view class="flex-1 flex" :class="[okLoading ? 'opacity-5' : '', 'overflow']" style="height: 90rpx">
                ...
                >
                  <view :userInteractionEnabled="false" class="flex flex-row">
                    <view v-if="okLoading" class="pr-10"><tm-icon :userInteractionEnabled="false" name="tmicon-shuaxin" spin></tm-icon></view>
