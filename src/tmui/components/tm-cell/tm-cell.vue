...
<template>
  <view class="relative overflow">
    <tm-sheet
      :dark-bg-color="props.darkBgColor"
      :color="props.color"
      ...
      @click="cellClick"
    >
      <view :user-interaction-enabled="true" class="flex flex-row flex-row-center-center" :class="[_computedValue.url ? 'url' : '']">
        <view
            ...
            <view class="flex flex-5 flex-col" :class="[_computedValue.showAvatar ? 'pl-24' : '']">
              <slot name="title">
                <tm-text
                  ...
                  :font-size="_computedValue.titleFontSize"
              ...
              <slot name="label">
                <view v-if="_computedValue.label" class="mt-6">
                  <tm-text
                    ...
                    :font-size="_computedValue.labelFontSize"
          ...
          <view class="flex-1 flex-row flex-row-center-end" style="width: 0px">
            <slot name="rightText">
              <tm-text
                ...
                :font-size="_computedValue.rightTextSize"
                :label="_computedValue.rightText"
              />
            </slot>
            <slot name="right">
              <tm-icon v-if="_computedValue.rightIcon" _class="opacity-3" :name="_computedValue.rightIcon" :font-size="22" />
            </slot>
          </view>
        </view>
      </view>
