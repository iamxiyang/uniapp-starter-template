<template>
  <view :hover-class="props.hoverClass" @click="emits('click', $event)" class="flex relative" v-if="colWidth" :style="[{ width: colWidth + 'px' }, props.height ? { height: props.height + 'rpx' } : '']">
    <view
